...
ActiveRecord::Schema.define(version: 20170119104952) do
  ...
  create_table "users_followed", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.integer  "user_id"
    ...
    t.datetime "created_at",   null: false
    t.datetime "updated_at",   null: false
    t.index ["user_id"], name: "index_users_followed_on_user_id", using: :btree
  end

  add_foreign_key "insta_accounts", "users"
  add_foreign_key "photos", "users"
  add_foreign_key "users_followed", "users"
end
